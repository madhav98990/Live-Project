...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        if os.path.exists(self.proj_name):
            ...
            self.class6 = simpledialog.askstring("Class 6", "What is the sixth class called?", parent=msg)
            self.class7 = simpledialog.askstring("Class 7", "What is the seventh class called?", parent=msg)
            self.class8 = simpledialog.askstring("Class 8", "What is the eighth class called?", parent=msg)
            self.class9 = simpledialog.askstring("Class 9", "What is the nineth class called?", parent=msg)
    ...
    def init_gui(self):
        ...
        class5_btn = Button(btn_frame, text=self.class6, command=lambda: self.save(6))
        class5_btn.grid(row=1, column=2, sticky=W + E)

        class5_btn = Button(btn_frame, text=self.class7, command=lambda: self.save(7))
        class5_btn.grid(row=2, column=0, sticky=W + E)

        class5_btn = Button(btn_frame, text=self.class8, command=lambda: self.save(8))
        class5_btn.grid(row=2, column=1, sticky=W + E)

        class5_btn = Button(btn_frame, text=self.class9, command=lambda: self.save(9))
        class5_btn.grid(row=2, column=2, sticky=W + E)
        ...
        self.status_label = Label(btn_frame, text=f"Current Model: {type(self.clf)._name_}")
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class1}", parent=self.root)
        elif prediction[0] == 2:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class2}", parent=self.root)
        elif prediction[0] == 3:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class3}", parent=self.root)
        elif prediction[0] == 4:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class4}", parent=self.root)
        elif prediction[0] == 5:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class5}", parent=self.root)
        elif prediction[0] == 6:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class6}", parent=self.root)
        elif prediction[0] == 7:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class7}", parent=self.root)
        elif prediction[0] == 8:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class8}", parent=self.root)
        elif prediction[0] == 9:
            tkinter.messagebox.showinfo("Sketch Classifier", f"The drawing is probably a {self.class9}", parent=self.root)
    ...
    def rotate_model(self):
        ...
        self.status_label.config(text=f"Current Model: {type(self.clf)._name_}")
    ...
    def save_everything(self):
        data = {"c1": self.class1, "c2": self.class2, "c3": self.class3, "c4": self.class4, "c5":self.class5, "c6":self.class6, "c7":self.class7, "c8":self.class8, "c9":self.class9, "c1c": self.class1_counter,
                "c2c": self.class2_counter, "c3c": self.class3_counter,"c4c": self.class4_counter,"c5c": self.class5_counter, "c6c": self.class6_counter, "c7c": self.class7_counter, "c8c": self.class8_counter, "c9c": self.class9_counter, "clf": self.clf, "pname": self.proj_name}
